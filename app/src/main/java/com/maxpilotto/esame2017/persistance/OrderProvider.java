...
public class OrderProvider extends ContentProvider {
    ...
    public static final String BASE_PATH_ORDER_PRODUCTS = "order_products";

    public static final int ALL_PRODUCTS = 100;
    public static final int ALL_ORDERS = 200;
    public static final int ALL_ORDER_PRODUCTS = 300;
    public static final int SINGLE_PRODUCT = 120;
    public static final int SINGLE_ORDER = 220;
    public static final int SINGLE_ORDER_PRODUCTS = 320;
    ...
    public static final String MIME_TYPE_ALL_ORDER_PRODUCTS = ContentResolver.CURSOR_DIR_BASE_TYPE + "vnd.all_order_products";
    ...
    public static final String MIME_TYPE_ORDER_PRODUCTS = ContentResolver.CURSOR_ITEM_BASE_TYPE + "vnd.single_order_products";
    ...
    public static final Uri URI_ORDER_PRODUCTS = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + AUTHORITY + "/" + BASE_PATH_ORDER_PRODUCTS);
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, BASE_PATH_ORDER_PRODUCTS, SINGLE_ORDER_PRODUCTS);
        uriMatcher.addURI(AUTHORITY, BASE_PATH_ORDER_PRODUCTS + "/#", SINGLE_ORDER_PRODUCTS);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_ORDER_PRODUCTS:
                builder.setTables(OrderProductsTable.TABLE_NAME);
                builder.appendWhere(OrderProductsTable._ID + " = " + uri.getLastPathSegment());
                break;
    ...
    public String getType(@NonNull Uri uri) {
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_ORDER_PRODUCTS:
                return MIME_TYPE_ORDER_PRODUCTS;

            case ALL_ORDER_PRODUCTS:
                return MIME_TYPE_ALL_ORDER_PRODUCTS;
        }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        if (uriMatcher.match(uri) == ALL_PRODUCTS) {
            ...
            return Uri.parse(resultString);
        } else if (uriMatcher.match(uri) == ALL_ORDER_PRODUCTS) {
            long result = Database.get().insert(values, OrderProductsTable.TABLE_NAME);
            String resultString = ContentResolver.SCHEME_CONTENT + "://" + BASE_PATH_ORDER_PRODUCTS + "/" + result;
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_ORDER_PRODUCTS:
                table = OrderProductsTable.TABLE_NAME;
                query = OrderProductsTable._ID + " = " + uri.getLastPathSegment();
                if (selection != null) {
                    query += " AND " + selection;
                }
                break;
